...
machine. Required tools: `uv`, `lbzip2`, `pv`, `tippecanoe`.
...
```bash
curl -L -r 0-1000000 https://dumps.wikimedia.org/wikidatawiki/entities/latest-all.json.bz2 | lbzip2 -dc | pv --force | grep '"P625"'
```
